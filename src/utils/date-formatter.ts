...
export class DateFormatter {
   ...
   */
  static formatToColombiaTime(date: Date | string | number, format: string = 'YYYY-MM-DD HH:mm:ss'): string {
   ...
   */
  static getColombiaTimeZoneOffset(): string {
    return '-05:00';
  }
}